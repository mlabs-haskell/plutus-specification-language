...
class
  ...
  requireOwnInput :: IsEType edsl d => Term edsl (EOwnUTXO d) -> Term edsl (EDiagram d)
  createOwnOutput :: IsEType edsl d => Term edsl (EOwnUTXO d) -> Term edsl (EDiagram d)
  ...
  toProtocol :: (IsEType edsl d, Protocol p d) => Proxy p -> Term edsl d -> Term edsl EValue -> Term edsl EUTXO
